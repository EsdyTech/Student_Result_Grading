...
if(isset($_POST['submit'])){
    ...
    if($courseId == 0000){ //check the courseID
      ...
      $statusMsg="This Course already exist in this department!";
        ...
        $query=mysqli_query($con,"insert into tblcourse(courseId,courseTitle,courseUnit,facultyId,departmentId,staffId,dateAdded) value('$courseId','$courseTitle','$courseUnit','$facultyId','$departmentId','$staffId','$dateAdded')");
                ...
                <br><br>
                    <div class="col-md-12">
                        <div class="card">
                            ...
                            <?php
        $ret=mysqli_query($con,"SELECT tblstaff.staffId, tblstaff.firstName, tblstaff.lastName,tblcourse.courseId,tblcourse.courseTitle,tblcourse.dateAdded,
