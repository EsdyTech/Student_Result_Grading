...
if(isset($_POST['submit'])){
    ...
    if($ret > 0){
      ...
      $statusMsg="This Course already exist in this department!";
        ...
        $query=mysqli_query($con,"update tblcourse set courseTitle='$courseTitle',courseUnit='$courseUnit',facultyId='$facultyId', departmentId='$departmentId', staffId='$staffId'
