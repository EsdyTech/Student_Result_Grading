        ...
        <div class="content">
            <div class="animated fadeIn">
                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-header">
                                <strong class="card-title"><h4 align="center">Compute <?php echo  $rowStd['firstName'].' '.$rowStd['lastName']?>&nbsp;<?php echo $rowLevel['levelName'];?>&nbsp;<?php echo $rowSemester['semesterName'];?> Semester Result</h></strong>
                            </div>
                            <form method="post">
                            <div class="card-body">
                                <p id="demo"></p>
                ...
                $cnt=$cnt+1;
                            ...
                            <button type="submit" onclick="myFunction()" name="compute" class="btn btn-primary">Compute Result</button>
                             </form>
                            </div>
                        </div>
                    </div>
