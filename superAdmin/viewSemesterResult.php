    ...
    <div id="right-panel" class="right-panel">
        ...
        <div class="content">
            <div class="animated fadeIn">
                ...
                <td bgcolor=""> </td>
                <td bgcolor=""> </td>
                <td bgcolor="yellow"><?php echo $totalCourseUnit;?></td>
                <td bgcolor=""> </td>
                <td bgcolor=""> </td>
                <td bgcolor=""> </td>
                <td bgcolor="yellow"><?php echo $totalScoreGradePoint;?></td>
                </tr>                                                          
                </tbody>
            </table>
<!-------------------------- FROM THE FINAL RESULT TABLE --------------------------->
        ...
        ?>
        <tr>
        <td bgcolor="yellow"><?php  echo $row['totalCourseUnit'];?></td>
        <td bgcolor="yellow"><?php  echo $row['totalScoreGradePoint'];?></td>
        <td bgcolor="yellow"><?php  echo $row['gpa'];?></td>
        <td bgcolor="yellow"><?php  echo $row['classOfDiploma'];?></td>
        </tr>
        <?php 
        $cnt=$cnt+1;
        }?>
                ...
                <a href="printSemesterResult.php?semesterId=<?php echo $semesterId;?>&matricNo=<?php echo $matricNo;?>&levelId=<?php echo $levelId;?>&sessionId=<?php echo $sessionId;?>" class="btn btn-primary">Print Result</a>
            </div>
        </div>
    </div>
