        ...
        <div class="content">
            <div class="animated fadeIn">
                ...
                if(isset($_POST['submit']))
                {
                    ...
                    <td><a href="viewSemesterResult.php?semesterId=1&matricNo=<?php echo $row['matricNo'];?>&levelId=<?php echo $row['levelId'];?>&sessionId=<?php echo $row['sessionId'];?>" title="View Details"><i class="fa fa-eye fa-1x">View</i></a></td>
                    <td><a href="viewSemesterResult.php?semesterId=2&matricNo=<?php echo $row['matricNo'];?>&levelId=<?php echo $row['levelId'];?>&sessionId=<?php echo $row['sessionId'];?>" title="View Details"><i class="fa fa-eye fa-1x">View</i></a></td>
                    <td><a href="viewFinalResult.php?matricNo=<?php echo $row['matricNo'];?>" title="View Details"><i class="fa fa-eye fa-1x">View</i></a></td>
                    </tr>
                    <?php 
                    $cnt=$cnt+1;
                    }
