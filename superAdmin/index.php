            ...
            <div class="animated fadeIn">
                ...
                <div class="row">
                  ...
                  <div class="col-lg-12">
                        <div class="card">
                            <div class="card-body">
                                <h3 align="center"><b>ADMINISTRATOR</b></h3>
                            </div>
                        ...
                        <div class="card text-white bg-flat-color-3">
                            <div class="card-body">
                                <div class="card-left pt-1 float-left">
                                    ...
                                    <p class="text-light mt-1 m-0">Computed Result</p>
                                </div><!-- /.card-left -->
             ...
             <div class="col-sm-6 col-lg-3">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-body">
                                <h3 align="center"><marquee direction="left">RESULT AND GRADING CRITERIA</marquee></h3>
                            </div>
                        </div>
                         </div>
                          </div>
