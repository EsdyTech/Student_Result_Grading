...
<body>
    ...
    <div id="right-panel" class="right-panel">
                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-header">
                                <strong class="card-title"><h4 align="center"><?php echo  $rowStd['firstName'].' '.$rowStd['lastName'].' '.$rowStd['otherName']?>&nbsp;Final Result</h></strong>
                            </div>
                            <div class="card-body">
        ...
        ?>
        <tr>
        <td bgcolor="yellow"><?php  echo $row['firstName'].' '.$row['lastName'].' '.$row['otherName'];?></td>
        <td bgcolor="yellow"><?php  echo $row['matricNo'];?></td>
        <td bgcolor="yellow"><?php  echo $row['facultyName'];?></td>
        <td bgcolor="yellow"><?php  echo $row['departmentName'];?></td>
        <td bgcolor="yellow"><?php  echo $row['cgpa'];?></td>
