...
<!-------------------------- FROM THE FINAL RESULT TABLE --------------------------->
     ...
     if (isset($_POST['submit'])){
        ...
        $cnt=$cnt+1;
                ...
                <a href="studentPrintResult.php?semesterId=<?php echo $semesterId;?>&matricNo=<?php echo $matricNo;?>&levelId=<?php echo $levelId;?>&sessionId=<?php echo $sessionId;?>" class="btn btn-primary">Print Result</a>
            </div>
        </div>
    </div>
<!-- end of datatable -->
